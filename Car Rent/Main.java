...
class Customer {
    ...
    public Customer(String customerId, String name, String licence, String adhar) {
    ...
    public void menu() {
        ...
        while (true) {
            ...
            if (choice == 1) {
                ...
                Customer newCustomer = new Customer("CUS" + (customers.size() + 1), customerName, licence, adhar);
